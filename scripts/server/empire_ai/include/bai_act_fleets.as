...
final class Armada {
	...
	void moveTo(BasicAI@ ai, Region@ region, bool tryFTL = true, Object@ around = null) {
		...
		bool doFTL = false;
		if(tryFTL && (ai.ftl == FTL_Hyperdrive || ai.ftl == FTL_Fling)) {
			int cost = 0;
			for(uint i = 0, cnt = fleets.length; i < cnt; ++i) {
				Ship@ ship = fleets[i];
...
class MakeDesign : Action {
	...
	bool perform(BasicAI@ ai) {
		if(!prepared) {
			...
			double goalScale = 1;
			int weaponCount = -1;
			bool supplies = true, support = true;
			int engineSize = 0, hyperSize = 0;
			int armorLevel = 0;
			...
			if(ai.cannotDesign) {
				...
				switch(type) {
					case DT_Support:
						if (ai.isAncients)  {
						switch(randomi(0,4)) {
							case 0: @baseDesign = ai.empire.getDesign("ANC Fighter Mk I"); break;
							case 1: @baseDesign = ai.empire.getDesign("ANC Atropos Mk I"); break;
							case 2: @baseDesign = ai.empire.getDesign("ANC Ceres Mk I"); break;
							case 3: @baseDesign = ai.empire.getDesign("ANC Atropos Mk I"); break;
							case 4: @baseDesign = ai.empire.getDesign("ANC Frigate Mk I"); break;
						}
						name = autoSupportNames[randomi(0,autoSupportNames.length-1)];
						tag = "Support";
						}
						else if (ai.isAncientsSojourners)  {
						switch(randomi(0,4)) {
							case 0: @baseDesign = ai.empire.getDesign("ANC Fighter Mk I"); break;
							case 1: @baseDesign = ai.empire.getDesign("ANC Atropos Mk I"); break;
							case 2: @baseDesign = ai.empire.getDesign("ANC Ceres Mk I"); break;
						...
						switch(randomi(0,2)) {
							case 0: @baseDesign = ai.empire.getDesign("ASG Gunship Mk I"); break;
							case 1: @baseDesign = ai.empire.getDesign("ASG Frigate Mk I"); break;
							case 2: @baseDesign = ai.empire.getDesign("ASG Cruiser Mk I"); break;
						}
						name = autoSupportNames[randomi(0,autoSupportNames.length-1)];
						tag = "Support";
						}
						...
						switch(randomi(0,4)) {
							case 0: @baseDesign = ai.empire.getDesign("GLD Death Glider Mk I"); break;
							case 1: @baseDesign = ai.empire.getDesign("GLD Al'kesh Mk I"); break;
							case 2: @baseDesign = ai.empire.getDesign("GLD Jan'tak Mk I"); break;
							case 3: @baseDesign = ai.empire.getDesign("GLD Ha'tak Mk I"); break;
							case 4: @baseDesign = ai.empire.getDesign("GLD Ha'tel Mk I"); break;
						}
						...
						switch(randomi(0,10)) {
							case 0: @baseDesign = ai.empire.getDesign("SGC F-302 Mk I"); break;
							case 1: @baseDesign = ai.empire.getDesign("SGC F-312 Mk I"); break;
							case 2: @baseDesign = ai.empire.getDesign("SGC Fenrir Mk I"); break;
							case 3: @baseDesign = ai.empire.getDesign("SGC Claudius Mk I"); break;
							case 4: @baseDesign = ai.empire.getDesign("SGC Tempest Mk I"); break;
							case 5: @baseDesign = ai.empire.getDesign("SGC Ares Mk I"); break;
							case 6: @baseDesign = ai.empire.getDesign("SGC Cerebus Mk I"); break;
							case 7: @baseDesign = ai.empire.getDesign("SGC Morpheus Mk I"); break;
							case 8: @baseDesign = ai.empire.getDesign("SGC Nyx Mk I"); break;
							case 9: @baseDesign = ai.empire.getDesign("SGC Phoenix Mk I"); break;
							case 10: @baseDesign = ai.empire.getDesign("SGC BC-303 Mk I"); break;
						}
						name = autoSupportNames[randomi(0,autoSupportNames.length-1)];
						tag = "Support";
						}
						...
						switch(randomi(0,3)) {
							case 0: @baseDesign = ai.empire.getDesign("WRA Dart Mk I"); break;
							case 1: @baseDesign = ai.empire.getDesign("WRA Fast Attack Mk I"); break;
							case 2: @baseDesign = ai.empire.getDesign("WRA Cruiser Mk I"); break;
							case 3: @baseDesign = ai.empire.getDesign("WRA Experimental Mk I"); break;
						}
						name = autoSupportNames[randomi(0,autoSupportNames.length-1)];
						tag = "Support";
						}
						...
						switch(randomi(0,14)) {
							case 0: @baseDesign = ai.empire.getDesign("EMP Acclamator Mk I"); break;
							case 1: @baseDesign = ai.empire.getDesign("EMP Carrack Mk I"); break;
							case 2: @baseDesign = ai.empire.getDesign("EMP CR92a Mk I"); break;
							case 3: @baseDesign = ai.empire.getDesign("EMP Eidolon Mk I"); break;
							case 4: @baseDesign = ai.empire.getDesign("EMP Gladiator Mk I"); break;
							case 5: @baseDesign = ai.empire.getDesign("EMP Lancer Mk I"); break;
							case 6: @baseDesign = ai.empire.getDesign("EMP Nebulon-B Mk I"); break;
							case 7: @baseDesign = ai.empire.getDesign("EMP Tector Mk I"); break;
							case 8: @baseDesign = ai.empire.getDesign("EMP Victory-I Mk I"); break;
							case 9: @baseDesign = ai.empire.getDesign("EMP Victory-II Mk I"); break;
							case 10: @baseDesign = ai.empire.getDesign("EMP Vigil Mk I"); break;
							case 11: @baseDesign = ai.empire.getDesign("EMP Tie Fighter Mk I"); break;
							case 12: @baseDesign = ai.empire.getDesign("EMP Tie Interceptor Mk I"); break;
							case 13: @baseDesign = ai.empire.getDesign("EMP Tie Advanced Mk I"); break;
							case 14: @baseDesign = ai.empire.getDesign("EMP Tie Bomber Mk I"); break;
						}
						name = autoSupportNames[randomi(0,autoSupportNames.length-1)];
						tag = "Support";
						}
						...
						switch(randomi(0,11)) {
							case 0: @baseDesign = ai.empire.getDesign("REP Acclamator Mk I"); break;
							case 1: @baseDesign = ai.empire.getDesign("REP Assault Frigate Mk I"); break;
							case 2: @baseDesign = ai.empire.getDesign("REP Carrack Mk I"); break;
							case 3: @baseDesign = ai.empire.getDesign("REP Consular Mk I"); break;
							case 4: @baseDesign = ai.empire.getDesign("REP CR92a Mk I"); break;
							case 5: @baseDesign = ai.empire.getDesign("REP DP20 Mk I"); break;
							case 6: @baseDesign = ai.empire.getDesign("REP Lancer Mk I"); break;
							case 7: @baseDesign = ai.empire.getDesign("REP MC30c Mk I"); break;
							case 8: @baseDesign = ai.empire.getDesign("REP Nebulon-B Mk I"); break;
							case 9: @baseDesign = ai.empire.getDesign("REP A-Wing Mk I"); break;
							case 10: @baseDesign = ai.empire.getDesign("REP X-Wing Mk I"); break;
							case 11: @baseDesign = ai.empire.getDesign("REP Y-Wing Mk I"); break;
						}
						name = autoSupportNames[randomi(0,autoSupportNames.length-1)];
						tag = "Support";
						}
						...
						switch(randomi(0,2)) {
							case 0: @baseDesign = ai.empire.getDesign("COL Viper Mk I"); break;
							case 1: @baseDesign = ai.empire.getDesign("COL Raptor Mk I"); break;
							case 2: @baseDesign = ai.empire.getDesign("COL Auriga Mk I"); break;
						}
						name = autoSupportNames[randomi(0,autoSupportNames.length-1)];
						tag = "Support";
						}
						...
						switch(randomi(0,3)) {
							case 0: @baseDesign = ai.empire.getDesign("CYL Fighter Mk I"); break;
							case 1: @baseDesign = ai.empire.getDesign("CYL Gunship Mk I"); break;
							case 2: @baseDesign = ai.empire.getDesign("CYL Raider Mk I"); break;
							case 3: @baseDesign = ai.empire.getDesign("CYL Heavy Raider Mk I"); break;
						}
						name = autoSupportNames[randomi(0,autoSupportNames.length-1)];
						tag = "Support";
						}
					...
					case DT_Flagship:
						if(task == FST_Scout) {
							if (ai.isAncients)  {
								@baseDesign = ai.empire.getDesign("ANC Scout");
							}
							else if (ai.isAncientsSojourners)  {
								@baseDesign = ai.empire.getDesign("ANC Scout");
							}
							else if (ai.isAsgard)  {
								@baseDesign = ai.empire.getDesign("ASG Scout");
							}
							else if (ai.isGoauld)  {
								@baseDesign = ai.empire.getDesign("GLD Scout");
							}
							else if (ai.isTauri)  {
								@baseDesign = ai.empire.getDesign("SGC Scout");
							}
							else if (ai.isWraith)  {
								@baseDesign = ai.empire.getDesign("WRA Scout");
							}
							else if (ai.isSWEmpire)  {
								@baseDesign = ai.empire.getDesign("EMP Scout");
							}
							else if (ai.isSWRepublic)  {
								@baseDesign = ai.empire.getDesign("REP Scout");
							}
							else if (ai.isBSGColonial)  {
								@baseDesign = ai.empire.getDesign("COL Scout");
							}
							else if (ai.isBSGCylon)  {
								@baseDesign = ai.empire.getDesign("CYL Scout");
							}
							else  {
								@baseDesign = ai.empire.getDesign("Scout");
							}
						}
						else if (ai.isAncients)  {
							switch(randomi(0,6)) {
								case 0: @baseDesign = ai.empire.getDesign("Aurora - Mk I"); break;
								case 1: @baseDesign = ai.empire.getDesign("Domivaitus - Mk I"); break;
								case 2: @baseDesign = ai.empire.getDesign("Destiny - Mk I"); break;
								case 3: @baseDesign = ai.empire.getDesign("Romulus - Mk I"); break;
								case 4: @baseDesign = ai.empire.getDesign("Anteus - Mk I"); break;
								case 5: @baseDesign = ai.empire.getDesign("Imperium - Mk I"); break;
								case 6: @baseDesign = ai.empire.getDesign("Invictus - Mk I"); break;
							}
						}
						else if (ai.isAncientsSojourners)  {
							switch(randomi(0,6)) {
							...
							switch(randomi(0,1)) {
								case 0: @baseDesign = ai.empire.getDesign("Beliskner - Mk I"); break;
								case 1: @baseDesign = ai.empire.getDesign("O'Neill - Mk I"); break;
							}
						}
						else if (ai.isGoauld)  {
							switch(randomi(0,3)) {
								case 0: @baseDesign = ai.empire.getDesign("Ra - Mk I"); break;
								case 1: @baseDesign = ai.empire.getDesign("Shu'tak - Mk I"); break;
								case 2: @baseDesign = ai.empire.getDesign("Apophis - Mk I"); break;
								case 3: @baseDesign = ai.empire.getDesign("Anubis - Mk I"); break;
							}
						}
						else if (ai.isTauri)  {
							switch(randomi(0,7)) {
								case 0: @baseDesign = ai.empire.getDesign("SGC BC-304 Mk I"); break;
								case 1: @baseDesign = ai.empire.getDesign("SGC Achilles Mk I"); break;
								case 2: @baseDesign = ai.empire.getDesign("SGC Concordia Mk I"); break;
								case 3: @baseDesign = ai.empire.getDesign("SGC Destiny Mk I"); break;
								case 4: @baseDesign = ai.empire.getDesign("SGC Excalibur Mk I"); break;
								case 5: @baseDesign = ai.empire.getDesign("SGC Hestia Mk I"); break;
								case 6: @baseDesign = ai.empire.getDesign("SGC Poseidon Mk I"); break;
								case 7: @baseDesign = ai.empire.getDesign("SGC Scorpion Mk I"); break;
							}
						}
						else if (ai.isWraith)  {
							switch(randomi(0,2)) {
								case 0: @baseDesign = ai.empire.getDesign("Sub Hive Mk I"); break;
								case 1: @baseDesign = ai.empire.getDesign("Assault Hive Mk I"); break;
								case 2: @baseDesign = ai.empire.getDesign("Super Hive Mk I"); break;
							}
						}
						else if (ai.isSWEmpire)  {
							switch(randomi(0,8)) {
								case 0: @baseDesign = ai.empire.getDesign("EMP Allegiance SD Mk I"); break;
								case 1: @baseDesign = ai.empire.getDesign("EMP Bellator Mk I"); break;
								case 2: @baseDesign = ai.empire.getDesign("EMP Demolisher SSD Mk I"); break;
								case 3: @baseDesign = ai.empire.getDesign("EMP Executor SSD Mk I"); break;
								case 4: @baseDesign = ai.empire.getDesign("EMP Imperial-II Mk I"); break;
								case 5: @baseDesign = ai.empire.getDesign("EMP Tyrant Mk I"); break;
								case 6: @baseDesign = ai.empire.getDesign("EMP Valiant Mk I"); break;
								case 7: @baseDesign = ai.empire.getDesign("EMP Venator Mk I"); break;
								case 8: @baseDesign = ai.empire.getDesign("EMP Vengeance Mk I"); break;
							}
						}
						else if (ai.isSWRepublic)  {
							switch(randomi(0,5)) {
								case 0: @baseDesign = ai.empire.getDesign("REP Home One Mk I"); break;
								case 1: @baseDesign = ai.empire.getDesign("REP Lucrehulk Mk I"); break;
								case 2: @baseDesign = ai.empire.getDesign("REP MC80 Mk I"); break;
								case 3: @baseDesign = ai.empire.getDesign("REP Recusant Mk I"); break;
								case 4: @baseDesign = ai.empire.getDesign("REP Valiant Mk I"); break;
								case 5: @baseDesign = ai.empire.getDesign("REP Venator Mk I"); break;
							}
						}
						else if (ai.isBSGColonial)  {
							switch(randomi(0,4)) {
								case 0: @baseDesign = ai.empire.getDesign("COL Valkyrie Mk I"); break;
								case 1: @baseDesign = ai.empire.getDesign("COL Tartarus Mk I"); break;
								case 2: @baseDesign = ai.empire.getDesign("COL Galactica Mk I"); break;
								case 3: @baseDesign = ai.empire.getDesign("COL Mercury Mk I"); break;
								case 4: @baseDesign = ai.empire.getDesign("COL Posiedon Mk I"); break;
							}
						}
						else if (ai.isBSGCylon)  {
							switch(randomi(0,3)) {
								case 0: @baseDesign = ai.empire.getDesign("CYL Y-Star Mk I"); break;
								case 1: @baseDesign = ai.empire.getDesign("CYL Attackstar Mk I"); break;
								case 2: @baseDesign = ai.empire.getDesign("CYL Basestar Mk I"); break;
								case 3: @baseDesign = ai.empire.getDesign("CYL Baseship Mk I"); break;
							}
						}
						else {
							switch(randomi(0,2)) {
			...
			designer.prepare(DesignType(type), goalScale, ai.empire, "Combat");
			designer.weaponCount = weaponCount;
			designer.supplies = supplies;
			designer.support = support;
			designer.engineSize = engineSize;
			designer.hyperSize = hyperSize;
			designer.armorLevel = armorLevel;
