...
class EventResult {
	...
	void trigger(CurrentEvent& evt, EventOption& opt) const {
...
interface IRandomOptionHook {
	bool shouldAdd(CurrentEvent& evt, EventOption& option) const;
	void trigger(CurrentEvent& evt, EventOption& option, const Target@ targ) const;
};

class RandomOptionHook : Hook, IRandomOptionHook {
	bool shouldAdd(CurrentEvent& evt, EventOption& option) const { return true; }
	void trigger(CurrentEvent& evt, EventOption& option, const Target@ targ) const {}
};
